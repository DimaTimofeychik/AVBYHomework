...
class ViewController: UIViewController {
    ...
    let cars: [CarInfo] = [
        ...
        CarInfo(carName: "Bentley Continental GT",
            carYear: 2019,
            milleage: 7000,
            capacity: 4.0,
    ...
    override func viewDidLoad() {
        ...
        title = (String(cars.count) + " объявлений")
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = mainScreenTableView.dequeueReusableCell(withIdentifier: "MainScreenTableViewCell", for: indexPath) as? MainScreenTableViewCell {
            ...
            cell.infoAboutCar(car: details, indexPath: indexPath, photos: details.images)
            cell.delegate = self
